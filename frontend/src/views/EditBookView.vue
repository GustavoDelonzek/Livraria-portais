<template>
    <main class="m-5">
        ...
        <form class="max-w-md mx-auto" @submit.prevent="UpdateBook" novalidate>
...
export default {
    ...
    methods: {
        async getBookById() {
            let url = `http://127.0.0.1:8000/api/get_book/${this.$route.params.id}`
    ...
    mounted: function () {
        console.log('Edit component form component')
    }
}
</script>