    ...
    <div class="bg-gray-100 flex rounded-2xl max-h-screen shadow-lg max-w-4xl w-full p-5  items-center">
      ...
      <div class="md:w-1/2 px-8 md:px-16 w-full">
        ...
        <form class="flex flex-col gap-4" @submit.prevent="login">
          <input class="p-2 mt-8 rounded-xl border" placeholder="Email" id="email" v-model="email" type="email" required>
          <div class="relative">
            <input class="p-2 rounded-xl border w-full" id="password" v-model="password" type="password" required placeholder="Password">
