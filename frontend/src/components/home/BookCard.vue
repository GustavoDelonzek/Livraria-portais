<template>
  <div class="flex flex-col justify-between items-center rounded-lg bg-white  mb-6 mt-2 p-4">
    <img :src="image" alt="Capa do Livro" class="w-48 h-64 object-cover rounded-md mb-4">
