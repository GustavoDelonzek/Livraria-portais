      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <RouterLink to="/admin/home" class="flex ms-2 md:me-24">
            <svg class="w-9 h-9 me-3 mt-1 text-gray-800 dark:text-white" aria-hidden="true"
          ...
          <div class="flex items-center ms-3">
            <div>
              <button type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="@/assets/Remove.png"
                  alt="user photo">
              </button>
            </div>
            <div
              ...
              <ul class="py-1" role="none">
                <RouterLink to="/">
                  <a href="#"
                    ...
                    role="menuitem">Site</a>
                </RouterLink>
                
                <li>
                  <router-link to="/login"
                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                    role="menuitem" @click="logout">Sign out</router-link>
                </li>
              </ul>
            </div>
          </div>
  ...
  <aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <RouterLink to="/admin/publishers"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <svg
              class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
