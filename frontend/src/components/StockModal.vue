<template>
    <button @click="openModal" :data-modal-target="`stock-modal-${bookId}`" :data-modal-toggle="`stock-modal-${bookId}`"  class="block text-white bg-blue-500
    hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5
